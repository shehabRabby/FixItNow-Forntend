            ...
            <div className="p-6 pt-2 space-y-6">
              <div className="text-center space-y-1.5">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">
                  Log in to manage your premium home services.
                </p>
              </div>

              {/* Modularized Login Form */}
              <LoginForm />
            </div>
          </div>

          {/* Trust Badges */}
          <div className="flex items-center justify-center gap-6 mt-8 text-xs font-medium text-slate-600 dark:text-slate-400">
