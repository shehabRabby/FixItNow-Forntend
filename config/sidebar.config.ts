...
export const roleBaseNavItems = {
  ADMIN: [
    ...
    { label: "Technicians", href: "/admin-dashboard/technicians", icon: Wrench },
  ...
  TECHNICIAN: [
    ...
    { label: "Bookings", href: "/technician-dashboard/bookings", icon: CalendarDays },
    { label: "Earnings", href: "/technician-dashboard/earnings", icon: DollarSign },
    { label: "Reviews", href: "/technician-dashboard/reviews", icon: Star },
    { label: "Support", href: "/technician-dashboard/support", icon: HelpCircle },
  ],
  CUSTOMER: [
    { label: "Dashboard", href: "/customer-dashboard", icon: LayoutDashboard },
    { label: "Bookings", href: "/customer-dashboard/bookings", icon: CalendarDays },
